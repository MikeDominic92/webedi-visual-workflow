  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center space-x-2 px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg hover:bg-zinc-700 transition-colors-shadow duration-200"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-2 w-56 bg-zinc-900 rounded-lg shadow-dark-lg border border-zinc-800 z-50"
            >
              <div className="p-2">
                <h3 className="text-sm font-semibold text-white px-3 py-2">
                  Export Options
                </h3>
                ...
                <button
                  ...
                  disabled={isExporting}
                  className="w-full flex items-center space-x-3 px-3 py-2 text-sm text-zinc-300 hover:bg-zinc-800 rounded-md transition-colors-shadow"
                >
